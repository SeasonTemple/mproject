    ...
    <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
      <el-form ref="detailForm" :model="detailForm" label-width="auto" class="detailStyle">
        ...
        <el-form-item label="用户名" prop="username">
          <el-input v-model="detailForm.username" minlength="8" maxlength="20" show-word-limit :style="formItemWidth"
            placeholder="填写你的用户名" v-bind="formState">
          </el-input>
        </el-form-item>
        <el-form-item label="密码" prop="password">
          <el-input v-model="detailForm.password" minlength="8" maxlength="20" show-password :style="formItemWidth"
            placeholder="填写你的密码" v-bind="formState"></el-input>
        </el-form-item>
        <el-form-item label="真实姓名" prop="realName">
          <el-input v-model="detailForm.realName" minlength="2" maxlength="10" :style="formItemWidth" show-word-limit
            placeholder="填写你的真实姓名" v-bind="formState">
          </el-input>
        </el-form-item>
        <el-form-item label="手机号" prop="phone">
          <el-input v-model="detailForm.phone" maxlength="11" show-word-limit :style="formItemWidth"
            placeholder="填写你的手机号" v-bind="formState">
          </el-input>
        </el-form-item>
        <el-form-item label="性别" prop="sex">
          <el-radio-group v-model="detailForm.sex" text-color="#F2F6FC" fill="#67C23A" size="medium" v-bind="formState">
            <el-radio-button label="1">男</el-radio-button>
            <el-radio-button label="0">女</el-radio-button>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="年龄" prop="age">
          <el-input-number v-model="detailForm.age" :min="1" :max="100" size="small" controls-position="right"
        ...
        <el-form-item label="职工号" prop="empId">
          <el-input v-model="detailForm.empId" maxlength="18" show-word-limit :style="formItemWidth"
        ...
        <el-form-item label="直属上级" prop="leader">
          <el-input v-model='detailForm.leaderName' minlength="2" maxlength="10" placeholder="你的直属上级姓名"
            :style="formItemWidth" v-bind="formState"></el-input>
        </el-form-item>
        <el-form-item label="入职日期" prop="createTime">
          <el-date-picker v-model="detailForm.createTime" value-format="yyyy-MM-dd HH:mm:ss" type="datetime"
            :picker-options="pickerOptions" :style="formItemWidth" v-bind="formState">
          </el-date-picker>
        </el-form-item>
